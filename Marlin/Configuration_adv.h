/**
 * Marlin 3D Printer Firmware - MPMD Bugfix
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       650 //380 //580        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  60 //37
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  60 //43 //44
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    #define Z_STALL_SENSITIVITY  62 //48 //40
